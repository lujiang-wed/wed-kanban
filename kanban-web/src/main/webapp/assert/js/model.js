$(document).ready(function () {
    ...
    $("#customedBox").find("div").bind("click", function () {
        var id = this.id;
        ...
        console.log(tr);
        $("#templeteTable").find("tr:last").after(tr);
    ...
    $("#upDown").find("div").bind("click", function () {
        ...
        if (rowCount.length > 1) {
            ...
            console.log(tr);
            $("#templeteTable2").find("tr:last").after(tr);
            $('#datetimepicker').datetimepicker({
                format: 'yyyy/mm/dd',
                language: 'zh-CN',
                autoclose: true,
    ...
    $("#opDown").find("div").bind("click", function () {
        ...
        if (rowCount.length > 0) {
            ...
            console.log(tr);
            $("#templeteTable3").find("tr:last").after(tr);
            $('#datetimepicker').datetimepicker({
                format: 'yyyy/mm/dd',
                language: 'zh-CN',
                autoclose: true,
