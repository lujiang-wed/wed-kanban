...
public class CardResult extends BaseEntity {
    /**
     所属空间
     */
     ...
     * 卡片自定义属性表
     */
    private List<CardAttrResult> cardAttrList;
    ...
    public List<CardAttrResult> getCardAttrList() {
        return cardAttrList;
    }

    public void setCardAttrList(List<CardAttrResult> cardAttrList) {
